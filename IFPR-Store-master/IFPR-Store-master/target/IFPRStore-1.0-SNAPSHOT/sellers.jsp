            ...
            <div class="table-responsive">
                <table class="table table-striped table-sm">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/sellers/delete?id=<%=seller.getId()%>" class="btn btn-sm btn-primary btn-danger">Excluir</a>
                            <a href="/sellers/update?id=<%=seller.getId()%>" class="btn btn-sm btn-primary">Editar</a>
                        </td>
                    </tr>
                    <%}%>
